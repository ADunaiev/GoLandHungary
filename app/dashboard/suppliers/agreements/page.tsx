...
import { fetchSuppliersAgreementsPages } from "@/app/lib/supplier_agreements/data";
import { CreateSupplierAgreement } from "@/app/ui/supplier_agreements/buttons";
import SuppliersAgreementsTable from "@/app/ui/supplier_agreements/table";
...
export default async function Page({
    ...
    const totalPages = await fetchSuppliersAgreementsPages(query);
    ...
    return (
      <div className="w-full">
        ...
        <div key='top_elements' className="mt-4 flex items-center justify-between gap-2 md:mt-8">
          ...
          <CreateSupplierAgreement key='create_agreement_btn' />
        </div>
        <Suspense key={query + currentPage} fallback={<InvoicesTableSkeleton />}>
          <SuppliersAgreementsTable query={query} currentPage={currentPage} />
        </Suspense>
