...
import {  } from "./buttons";
import { fetchSuppliersAgreementsBySupplierId } from "@/app/lib/supplier_agreements/data";

export default async function SuppliersAgreementsTableBySupplier({ supplier_id } : {
    supplier_id: string,
}) {
    const agreements = await fetchSuppliersAgreementsBySupplierId(supplier_id);
