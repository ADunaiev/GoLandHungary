...
import { UpdateRate, DeleteRate, RemoveRateFromShipmentInvoice, RestoreRatesInShipmentInvoice, RemoveRateFromShipmentEditInvoice } from '@/app/ui/rates/buttons'

export default async function RatesTableShipmentEditInvoice({ rates, shipment_id, invoice_id } : { 
  rates: RateTable[],
  invoice_id: string,
  shipment_id: string,
}) {
                  ...
                  >
                    ...
                    <div className="flex w-full items-center justify-between pt-4">
                      ...
                      <div className="flex justify-end gap-2">
                        <RemoveRateFromShipmentEditInvoice shipment_id={shipment_id} invoice_id={invoice_id} rate_id={rate.id} />
                      </div>
                    </div>
                  </div>
                ))}
