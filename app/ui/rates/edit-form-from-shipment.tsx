...
import { createInvoiceRate, updateInvoiceRate, updateRateFromShipment } from "@/app/lib/actions"
import { 
    CurrencyEuroIcon, 
    TruckIcon, 
    CircleStackIcon, 
...
import { UpdateRateFromShipment } from "./buttons"
import { fetchShipmentById } from "@/app/lib/data"
import { toast } from "sonner"

type RateType = Zod.infer<typeof InvoiceRateFormSchema>

export default function EditRateFormFromShipment({
    services,
    currencies,
    vat_rates,
    routes,
    ...
    const updateRateFromShipmentWithId = updateRateFromShipment.bind(null, rate.shipment_id, rate.id);
    ...
    const onSubmit = async (data:RateType) => {
        try {
            const response = await updateRateFromShipmentWithId(data);
                ...
                <div className="mb-4">
                    ...
                    <div className="relative">
                        <select
                            ...
                            >
                            <option key="shipment" value={rate.shipment_id}>
