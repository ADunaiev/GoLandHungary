...
import { UpdateRate, DeleteRate, RemoveRateFromShipmentInvoice, RestoreRatesInShipmentInvoice } from '@/app/ui/rates/buttons'

export default async function RatesTableShipment({ rates, shipment_id } : { 
  rates: RateTable[],
  shipment_id: string,
}) {
    return (
            ...
            <div className="rounded-lg bg-gray-50 p-2 md:pt-0">
              <div className="md:hidden">
                <div className="w-full flex justify-end mb-2">
                  <RestoreRatesInShipmentInvoice shipment_id={shipment_id} />
                </div>
                {rates?.map((rate) => (
                  <div
                    key={rate.id + 'i'}
                  ...
                  >
                    ...
                    <div className="flex w-full items-center justify-between pt-4">
                      ...
                      <div className="flex justify-end gap-2">
                        <RemoveRateFromShipmentInvoice shipment_id={shipment_id} rate_id={rate.id} />
                      </div>
                    </div>
                  </div>
                ))}
