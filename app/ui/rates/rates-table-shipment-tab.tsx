...
import { UpdateRate, DeleteRate, DeleteRateFromShipment, UpdateRateFromShipment } from '@/app/ui/rates/buttons'

export default async function RatesTableShipmentTab({ rates, shipment_id } : { 
  rates: RateTable[],
  shipment_id: string,
}) {
    return (
                  ...
                  >
                    ...
                    <div className="flex w-full items-center justify-between pt-4">
                      ...
                      <div className="flex justify-end gap-2">
                        <UpdateRateFromShipment shipment_id={shipment_id} rate_id={rate.id} />
